...
export type GooeyNavProps = {
  ...
  /** Si se define, el click no navega: útil para tabs. */
...
export default function GooeyNav({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- posicionar efecto al montar / cambiar índice
  }, [activeIndex]);

  return (
    <div
      className={["gooey-nav-container", className].filter(Boolean).join(" ")}
      ref={containerRef}
    >
      <nav aria-label="Servicios de asesoría">
