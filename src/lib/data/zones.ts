...
export const ZONE_CATALOG: ZoneCatalogEntry[] = [
  {
    ...
    subZones: ["Zibatá", "Zakia", "Zizana", "Ziré", "La Vista", "El Mayorazgo"],
    image:
  ...
  },
  {
    ...
    growthLabel: "Crecimiento alto",
    description:
      "Corredor industrial y logístico de primer nivel con alta conectividad terrestre, parques corporativos y cercanía al aeropuerto.",
    subZones: [
